...
//    private static Map<String, ChannelHandlerContext> channels = new ConcurrentHashMap<>();
     ...
     * value ：Username
     */
    private static Map<String, String> codeMappingUsername = new ConcurrentHashMap<>();
...
//    }
    ...
    public void addCodeMappingUsername(String code, String username) {
        codeMappingUsername.put(code, username);
    }

    public String getUsernameByCode(String code) {
        return codeMappingUsername.get(code);
    }
