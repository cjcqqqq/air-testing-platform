...
import com.university.shenyang.air.testing.app.response.QueryAllDeviceResponse;
import com.university.shenyang.air.testing.app.response.QueryOneDeviceResponse;
...
public class DeviceController extends BaseController {
    ...
    public QueryAllDeviceResponse getAllLatestDevice(@Validated QueryAllDeviceCommand command, BindingResult bindingResult) throws RuntimeException {
        QueryAllDeviceResponse result = new QueryAllDeviceResponse();
    ...
    public QueryOneDeviceResponse getAllLatestDevice(@Validated QueryOneDeviceCommand command, BindingResult bindingResult) throws RuntimeException {
        QueryOneDeviceResponse result = new QueryOneDeviceResponse();
        if (bindingResult.hasErrors()) {
            bindingResultFill(result, bindingResult);
        } else {
    ...
    public QueryAllDeviceResponse queryDeviceByUserAndTime(@Validated QueryDeviceByUserAndMinutesCommand command, BindingResult bindingResult) throws RuntimeException {
        QueryAllDeviceResponse result = new QueryAllDeviceResponse();
        if (bindingResult.hasErrors()) {
            bindingResultFill(result, bindingResult);
        } else {
