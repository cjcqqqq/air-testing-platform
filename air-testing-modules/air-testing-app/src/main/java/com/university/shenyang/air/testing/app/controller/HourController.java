...
import com.university.shenyang.air.testing.app.response.QueryOneHourInfoByDeviceCodeResponse;
...
public class HourController extends BaseController {
    ...
    public QueryOneHourInfoByDeviceCodeResponse queryOneHour(@Validated QueryOneHourInfoByDeviceCodeCommand command, BindingResult bindingResult) throws RuntimeException {
        QueryOneHourInfoByDeviceCodeResponse result = new QueryOneHourInfoByDeviceCodeResponse();
