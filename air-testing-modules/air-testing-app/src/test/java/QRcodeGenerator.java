...
public class QRcodeGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 201; i < 5201; i++) {
            deviceCodes.add("deviceCode" + String.format("%07d", i));
        }
...
//        qrCodeImageGeneration("http://47.104.152.135:8089/download/air-testing.apk", width, height, "android", format);
    }
    ...
    private static void qrCodeImageGeneration(String text, int width, int height, String filename, String imgFmt) throws WriterException, IOException {
        ...
        // 生成二维码
        File outputFile = new File("d://QRcode//20191120//" + filename + "." + imgFmt);
